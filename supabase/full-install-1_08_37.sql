...
begin
  ...
  if miss <> '' then
    ...
    raise notice 'TechLog: схема соответствует v1.08.37 — всё на месте.';
  end if;
end $$;

select 'TechLog v1.08.37 — скрипт выполнен. Смотрите NOTICE выше: «всё на месте» = готово.' as result;
