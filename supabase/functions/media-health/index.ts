import { svc, userClient, driveToken, monthFolder, CORS, jres, FN_VER,
         PHOTOS_DIR, FILES_DIR, INVOICES_DIR, folderIdOf, ymDir, techDirLabel, BLOCKED_SUFFIX, stripBlocked, rootFolder, rootFolderInfo, ARCHIVE_DIR, ROOT_DIR } from "../_shared/google.ts";
