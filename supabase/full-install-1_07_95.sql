-- =====================================================================
-- TechLog · ЕДИНЫЙ ПОЛНЫЙ СКРИПТ БАЗЫ · v1.07.95
-- =====================================================================
...
begin
  ...
  if miss <> '' then
    ...
    raise notice 'TechLog: схема соответствует v1.07.95 — всё на месте.';
  end if;
end $$;

select 'TechLog v1.07.95 — скрипт выполнен. Смотрите NOTICE выше: «всё на месте» = готово.' as result;
