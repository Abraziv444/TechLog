-- =====================================================================
-- TechLog · ЕДИНЫЙ ПОЛНЫЙ СКРИПТ БАЗЫ · v1.07.87
-- =====================================================================
...
begin
  ...
  if miss <> '' then
    ...
    raise notice 'TechLog: схема соответствует v1.07.87 — всё на месте.';
  end if;
end $$;

select 'TechLog v1.07.87 — скрипт выполнен. Смотрите NOTICE выше: «всё на месте» = готово.' as result;
