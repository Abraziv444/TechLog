...
Актуально для v1.09.01. Клиент (GitHub Pages) и сервер обновляются независимо:
...
| Ситуация | Файл |
|---|---|
| Новый проект или база любого возраста | `full-install-1_09_01.sql` — один идемпотентный скрипт, добавляет только недостающее |
