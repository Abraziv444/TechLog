...
### Функция `dft` — только для «Теста документооборота» (v1.09.27; в 1.09.28 добавлена `job_adopt`, в 1.09.30 — документ ремонта и приём в тест, в 1.09.31 — отчёт о пушах и уборка файлов с Google Диска: после обновления функцию нужно передеплоить; ей нужен тот же доступ к Диску, что и функциям media-*)
