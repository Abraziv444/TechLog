-- =====================================================================
-- TechLog · ЕДИНЫЙ ПОЛНЫЙ СКРИПТ БАЗЫ · v1.08.17
-- =====================================================================
...
-- ============================================================
-- Итоговая самопроверка схемы v1.08.23
-- ============================================================
do $$
declare miss text := '';
begin
  ...
  if miss <> '' then
    ...
    raise notice 'TechLog: схема соответствует v1.08.23 — всё на месте.';
  end if;
end $$;

select 'TechLog v1.08.23 — скрипт выполнен. Смотрите NOTICE выше: «всё на месте» = готово.' as result;
